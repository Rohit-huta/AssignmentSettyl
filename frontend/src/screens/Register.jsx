...
const Register = () => {
    ...
    return (
      <div className="container w-50 text-start position-relative">
        <h1 className='text-center font-bold text-2xl my-5'>Registration Form</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='md:flex md:flex-col'>
            <button type="submit" className="btn btn-primary bg-slate-600 w-min">
                Register
            </button>
            <a href='/login' className='text-primary'>Already register? Login</a>
          </div>
        </form>
          {/* { user && <div>
